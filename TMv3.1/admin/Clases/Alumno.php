...
class Alumno{
   ...
   public function get_alumno($matricula = null, $idestatus = false){
      try {          
   ...
   public function exclude_alumno($matricula, $idestatus){
       try{
         $sql = "UPDATE alumno SET idestatus=:idestatus WHERE matricula = :matricula";
